...
/// <summary>
///     Generic MongoDB repository implementation for ViewModelBase entities with pagination support
/// </summary>
/// <typeparam name="T">ViewModelBase entity type</typeparam>
public class GenericMongoViewModelRepository<T> : IGenericRepository<T> where T : ViewModelBase
{
    protected readonly IMongoCollection<T> _collection;
    protected readonly ILogger _logger;

    public GenericMongoViewModelRepository(
    ...
    public virtual async Task UpdateAsync(T entity)
    {
        ...
        // This is now 100% type-safe. The driver knows `e.Id` maps to the `_id` field.
